...
class ContactItem extends React.Component {
    ...
    render() {
        const { avatar, description, name, gender, facebbok, twitt, linked, messs, skyPe } = this.state;
        ...
        return (
            ...
            <div className="row d-flex">
                <div onMouseEnter={this.Active} onMouseLeave={this.UnActive} className={border}>
                    <div className="panel">
                        <div className="panel-body p-t-10">
                            ...
                            <ul className="social-links list-inline p-b-10  d-flex">
                                <li>
                                    <a title="" data-placement="top" data-toggle="tooltip" className="tooltips" target="blank" href={fb} data-original-title="Facebook"><i className="fa fa-facebook"></i></a>
                                </li>
                                <li>
                                    <a title="" data-placement="top" data-toggle="tooltip" className="tooltips" target="blank" href={tw} data-original-title="Twitter"><i className="fa fa-twitter"></i></a>
                                </li>
                                <li>
                                    <a title="" data-placement="top" data-toggle="tooltip" className="tooltips" target="blank" href={lin} data-original-title="LinkedIn"><i className="fa fa-linkedin"></i></a>
                                </li>
                                <li>
                                    <a title="" data-placement="top" data-toggle="tooltip" className="tooltips" target="blank" href={skype} data-original-title="Skype"><i className="fa fa-skype"></i></a>
                                </li>
                                <li>
                                    <a title="" data-placement="top" data-toggle="tooltip" className="tooltips" target="blank" href={me} data-original-title="Message"><i className="fa fa-envelope-o"></i></a>
                                </li>
                            </ul>
                            <span className="star"><i className="fa fa-star"></i></span>
                            <button type="button" className={btnStyle} onClick={this.RandomAvatar}>RandomFace</button>
                        </div>
                    </div>
                </div>
            </div>
